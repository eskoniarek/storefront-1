...
const PrivacyPolicy = () => {
    return (
        <>
            <Nav />
            <main className="px-container prose-custom mx-auto !max-w-container pb-36 pt-12">
                <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-md space-y-6 prose prose-blue">
                    <h1 className="text-2xl font-bold mb-6 border-b pb-3 text-center">TERMS AND CONDITIONS OF SALE</h1>
                    ...
                    <h2 className="text-xl font-semibold">2. CONTRACTS AND ORDERS</h2>
                    ...
                    <h2 className="text-xl font-semibold">3. CUSTOMER INFORMATION ETC.</h2>
                    ...
                    <h2 className="text-xl font-semibold">4. PRICES, FEES AND PAYMENT</h2>
                    ...
                    <h2 className="text-xl font-semibold">13. CHANGES TO THE GENERAL CONDITIONS</h2>
